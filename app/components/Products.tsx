    ...
    <section id="products" className="py-24 px-6 max-w-7xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <GlassCard hoverColor="amber">
          ...
          <a href="https://toruscode.io" target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-amber-400 hover:text-amber-300 transition-colors inline-flex items-center gap-2">
            Deploy Now <Icon icon="lucide:arrow-up-right" className="w-4 h-4" />
          </a>
        </GlassCard>
        ...
        <GlassCard hoverColor="purple">
          ...
          <ul className="text-xs text-neutral-500 space-y-2 mb-6">
            ...
            <li className="flex items-center gap-2"><Icon icon="lucide:check" className="w-4 h-4" /> AI agent messaging</li>
          </ul>
          <a href="https://toruscrm.io" target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-purple-400 hover:text-purple-300 transition-colors inline-flex items-center gap-2">
        ...
        <GlassCard hoverColor="green">
          ...
          <a href="https://toruschat.io" target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-green-400 hover:text-green-300 transition-colors inline-flex items-center gap-2">
        ...
        <GlassCard hoverColor="cyan">
          ...
          <ul className="text-xs text-neutral-500 space-y-2 mb-6">
            ...
            <li className="flex items-center gap-2"><Icon icon="lucide:check" className="w-4 h-4" /> Agent workflow triggers</li>
