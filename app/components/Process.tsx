      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row gap-16">
          ...
          <div className="md:w-1/3 md:sticky md:top-32 md:h-fit">
            ...
            <a
              href="#contact"
              className="inline-block px-5 py-2.5 rounded-lg bg-white text-black font-medium text-sm hover:bg-neutral-200 transition-colors"
            >
              Start the Process
            </a>
          </div>
          ...
          <div className="md:w-2/3 space-y-12">
            ...
            <div className="flex gap-6">
              ...
              <div className="pb-8">
                ...
                <p className="text-neutral-400 text-sm">Rigorous testing to ensure the system handles objections, accents, and edge cases correctly. We refine latency and response quality together.</p>
              </div>
            </div>
